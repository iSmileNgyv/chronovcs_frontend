...
export function RepoHeader({ username, repoName }: RepoHeaderProps) {
    return (
        <div className="flex flex-col gap-6">
            ...
            <div className="pb-3">
                <div className="flex border-b border-border-light dark:border-border-dark gap-6 overflow-x-auto">
                    <Link
                        className="flex items-center justify-center border-b-[3px] border-b-primary text-text-light dark:text-text-dark gap-2 pb-2.5 pt-1 whitespace-nowrap"
                        href="#"
                    >
                    ...
                    <Link
                        className="flex items-center justify-center border-b-[3px] border-b-transparent text-secondary-text-light dark:text-secondary-text-dark hover:text-text-light dark:hover:text-text-dark gap-2 pb-2.5 pt-1 whitespace-nowrap transition-colors"
                        href="#"
                    >
